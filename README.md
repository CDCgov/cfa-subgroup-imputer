...
This repo contains a python package for imputing values in subgroups from values recorded for supergroups.

## Getting started

This is a [uv project](https://docs.astral.sh/uv/guides/projects/). Eventually, there will be two ways to use this codebase.
...
- Andrew Magee <rzg0@cdc.gov> (CDC/IOD/ORR/CFA)
