...
The following is an excerpt of national vaccination uptake data from NIS (sw5n-wg2p), providing the estimated vaccine coverage for several weeks in October 2023, broken down by age groups.
```
